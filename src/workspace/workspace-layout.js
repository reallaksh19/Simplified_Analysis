export function renderWorkspaceLayout(rootElement) {
  ...
  rootElement.innerHTML = `
    <div class="application-shell">
      <nav class="application-navigation" data-role="application-navigation" role="tablist" aria-label="Application views"></nav>
      <div data-application-view="WORKSPACE">
        <main class="workspace-shell" aria-label="Analysis Workspace">
          ...
          <section class="workspace-panel viewport-panel" data-panel="viewport" aria-label="3D viewport">
            <header class="viewport-toolbar"><div><span class="panel-eyebrow">Read-only model review</span><h2>Model Viewport</h2></div>
      ...
      <div class="reports-view" data-application-view="REPORTS" data-role="reports-view" hidden></div>
    </div>`;
}