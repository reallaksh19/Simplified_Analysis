...
function workspaceMarkup() {
  return `<div class="application-shell" data-role="application-shell">
    ...
    <main class="workspace-shell" aria-label="Analysis Workspace">
      ...
      <div class="application-view application-view--local-stress" data-application-view="LOCAL_STRESS" hidden aria-hidden="true"><div data-role="local-stress-consumer-root"></div></div>
    </div>`;
}
function shellStyles() {
  return `
    ...
    .application-view--reports,.application-view--load-calc,.application-view--three-d-calc,.application-view--pipe-solver,.application-view--local-stress{overflow:auto;background:var(--workspace-canvas)}
    .reports-consumer,.load-calc-consumer,.three-d-calc-consumer,.pipe-solver-consumer,.local-stress-consumer{display:grid;gap:14px;max-width:1500px;margin:0 auto;padding:18px;min-width:0}
    .reports-consumer__header,.load-calc-consumer__header,.three-d-calc-consumer__header,.pipe-solver-consumer__header,.local-stress-consumer__header{display:flex;align-items:flex-start;justify-content:space-between;gap:20px}.reports-consumer__header h1,.load-calc-consumer__header h1,.three-d-calc-consumer__header h1,.pipe-solver-consumer__header h1,.local-stress-consumer__header h1{margin:4px 0 0}
    .reports-consumer__disclaimer,.reports-consumer__footer,.load-calc-consumer__claim,.three-d-calc-consumer__claim,.pipe-solver-consumer__claim,.local-stress-consumer__claim{max-width:680px;color:#fbbf24;font-weight:700}
    ...
    .reports-card,.load-calc-card,.three-d-calc-card,.pipe-solver-card,.local-stress-card{min-width:0;padding:14px;border:1px solid var(--workspace-border);border-radius:7px;background:var(--workspace-panel)}.reports-card h2,.load-calc-card h2,.three-d-calc-card h2,.pipe-solver-card h2,.local-stress-card h2{margin:0 0 10px;font-size:14px}
    ...
    .local-stress-form{display:grid;gap:14px}.local-stress-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:12px}.local-stress-grid--compact{grid-template-columns:repeat(3,minmax(0,1fr))}.local-stress-grid fieldset{min-width:0;margin:0;padding:10px;border:1px solid #334155;border-radius:6px}.local-stress-grid legend{padding:0 5px;color:#bfdbfe;font-weight:700;font-size:12px}.local-stress-vector{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:7px}
    .local-stress-form label{display:grid;gap:5px;min-width:0;color:var(--workspace-muted);font-size:11px}.local-stress-form input,.local-stress-form select,.local-stress-actions button{min-width:0;border:1px solid #334155;border-radius:5px;padding:8px;background:#0b1628;color:var(--workspace-text)}.local-stress-form input:focus-visible,.local-stress-form select:focus-visible,.local-stress-actions button:focus-visible{outline:2px solid rgba(96,165,250,.55);outline-offset:2px}.local-stress-actions{display:flex;align-items:center;gap:12px}.local-stress-actions button{cursor:pointer;font-weight:700}.local-stress-actions output{color:#fca5a5;font-weight:700}.local-stress-help{margin:0 0 10px;color:var(--workspace-muted)}
    .local-stress-summary{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:8px;margin:0}.local-stress-summary div{min-width:0;padding:9px;background:#060b14}.local-stress-summary dt{color:var(--workspace-muted);font-size:11px}.local-stress-summary dd{margin:4px 0 0;overflow-wrap:anywhere;font-weight:700}.local-stress-card details{margin-top:12px}.local-stress-card pre{max-height:420px;overflow:auto;white-space:pre-wrap;overflow-wrap:anywhere;padding:10px;background:#060b14;border-radius:5px}
    .visually-hidden{position:absolute;width:1px;height:1px;padding:0;margin:-1px;overflow:hidden;clip:rect(0,0,0,0);white-space:nowrap;border:0}
    @media(max-width:1100px){.application-navigation{flex-wrap:wrap}.reports-card dl,.load-calc-card dl,.three-d-calc-card dl,.pipe-solver-card dl{grid-template-columns:repeat(2,minmax(0,1fr))}.local-stress-grid--compact{grid-template-columns:repeat(2,minmax(0,1fr))}}
    @media(max-width:760px){.application-shell{height:auto;min-height:100vh;overflow:visible}.application-view{overflow:visible}.application-view--workspace .workspace-shell{height:auto}.reports-consumer__header,.load-calc-consumer__header,.three-d-calc-consumer__header,.pipe-solver-consumer__header,.local-stress-consumer__header{display:grid}.reports-card dl,.load-calc-card dl,.three-d-calc-card dl,.pipe-solver-card dl,.local-stress-grid,.local-stress-grid--compact,.local-stress-summary{grid-template-columns:minmax(0,1fr)}}`;
}
