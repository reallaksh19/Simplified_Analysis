...
function descriptorRows(version) {
  ...
  return [
    ...
    ...current,
    recoveryRow(CONSUMER_IDS.PCF, 'PCF', 'PCF intake and review recovery has not yet been migrated.'),
...
function recoveryRow(consumerId, label, purpose) {
  return row(consumerId, label, purpose, IMPLEMENTATION_STATUS.RECOVERY_PENDING, [], [], [], 'NO_ENGINEERING_CLAIMS');
}
