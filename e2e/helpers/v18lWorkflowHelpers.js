...
export async function openSketcher(page) {
  ...
  const clicked = await clickFirstVisible(page, [
    ...
    page.getByRole('button', { name: /2D Sketcher|Sketcher|Smart 2D/i }),
    page.getByText(/Geometry \/ Sketcher/i),
    page.getByText(/2D Sketcher|Sketcher|Smart 2D/i),
    page.locator('[data-testid="nav-sketcher"]'),
    page.locator('[data-tab="sketcher"]'),
  ]);
...
export async function open3DSimplified(page) {
  const clicked = await clickFirstVisible(page, [
    ...
    page.getByText(/3D Simplified Calculation/i),
    page.getByText(/3D Simplified|3D Guided|3D Analysis|3D GC/i),
    page.locator('[data-testid="nav-3d-analysis"]'),
    page.locator('[data-tab="3d-analysis"]'),
  ]);
