...
if(selected==='all')Object.values(checks).forEach((check)=>check());else if(checks[selected])checks[selected]();else throw new TypeError(`Unknown W10.10 source-guard check: ${selected}.`);
...
console.log(`✅ W10.10 source guard ${selected} passed for ${changed.length} changed file(s).`);
